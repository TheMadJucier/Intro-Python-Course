# -*- coding: utf-8 -*-
"""
Created on Sun Jul 10 16:51:56 2022
...
def is_valid_day_in_month(month, day, year):
    """ Takes 3 inputs, month, day, and year, and checks to see if a given day
        exist during a said month, depending or not if its a leap year
    """
...
def get_month_name(month):
    """ Assigns a month number to a month date, given a said parameter month"""
...
def is_valid_date(month, day, year):
    """Checks to see if the date exist, by using all of the helper functions"""
    if(is_valid_month(month)):
...
if __name__ == '__main__':
    ...
    print("is_valid_date(13,32,2018): ", is_valid_date(10, 32, 2018))
